                                ...
                                <div className="px-12">
                                    ...
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center sm:divide-x-2 sm:divide-gray-500">
                                            <div className="sm:pr-3 font-medium text-gray-800 text-sm md:text-base">Kelvin Karani</div>
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    ...
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center sm:divide-x-2 sm:divide-gray-500">
                                            <div className="sm:pr-3 font-medium text-gray-800">Alfred James</div>
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    ...
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center sm:divide-x-2 sm:divide-gray-500">
                                            <div className="sm:pr-3 font-medium text-gray-800">Anjela</div>
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    ...
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center sm:divide-x-2 sm:divide-gray-500">
                                            <div className="sm:pr-3 font-medium text-gray-800">Hillary Anold</div>
